 ...
 */ (function(
  ...
  function l(e, t) {
    var o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
      ...
      r = o ? -1 : 1;
    return (e.top +=
      i * r), (e.bottom += i * r), (e.left += n * r), (e.right += n * r), e;
  }
  function f(e, t) {
    var o = "x" === t ? "Left" : "Top",
  ...
  function u(e, o) {
    ...
    if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
      ...
      (h.top -= f - u), (h.bottom -= f - u), (h.left -= m - b), (h.right -=
        m - b), (h.marginTop = u), (h.marginLeft = b);
    }
    return (i ? o.contains(d) : o === d && "BODY" !== d.nodeName) &&
      (h = l(h, o)), h;
  }
  function b(e) {
    ...
    if ("viewport" === r) p = b(s);
      ...
      if ("HTML" === a.nodeName && !w(s)) {
        var f = h(),
          m = f.height,
          c = f.width;
        (p.top += l.top - l.marginTop), (p.bottom = m + l.top), (p.left +=
          l.left - l.marginLeft), (p.right = c + l.left);
      } else p = l;
    }
  ...
  function S(e, t, o) {
    ...
    var i = L(e),
      ...
      a = r ? "width" : "height";
    return (n[p] =
      t[p] + t[d] / 2 - i[d] / 2), (n[s] = o === s ? t[s] - i[a] : t[x(s)]), n;
  }
  function T(e, t) {
  ...
  function N() {
    if (!this.state.isDestroyed) {
      ...
      )), (e.originalPlacement = e.placement), (e.offsets.popper = S(
        this.popper,
        e.offsets.reference,
        e.placement
      )), (e.offsets.popper.position = "absolute"), (e = C(
        this.modifiers,
        e
  ...
  function M(e, t) {
    return B(e).removeEventListener(
      "resize",
      t.updateBound
  ...
  var i,
    ...
    ie = function() {
      return void 0 == i &&
        (i = -1 !== navigator.appVersion.indexOf("MSIE 10")), i;
    },
    ne = function(e, t) {
      if (!(e instanceof t))
    ...
    fe = (function() {
      function t(o, i) {
        ...
        ne(this, t), (this.scheduleUpdate = function() {
          ...
          i && i.jquery ? i[0] : i), (this.options.modifiers = {}), Object.keys(
  ...
  return (fe.Utils = ("undefined" == typeof window
    ? global
    : window).PopperUtils), (fe.placements = de), (fe.Defaults = {
    placement: "bottom",
    eventsEnabled: !0,
    removeOnDestroy: !1,
    onCreate: function() {},
    ...
    modifiers: {
      ...
      keepTogether: {
        ...
        fn: function(e) {
          var t = e.offsets,
            ...
            d = p ? "left" : "top",
            a = p ? "width" : "height";
          return o[s] < r(i[d]) && (e.offsets.popper[d] = r(i[d]) - o[a]), o[
            d
      ...
      arrow: {
        ...
        fn: function(e, o) {
          ...
          var r = e.placement.split("-")[0],
            ...
            g = a ? "bottom" : "right",
            u = L(n)[l];
          d[g] - u < s[m] && (e.offsets.popper[m] -= s[m] - (d[g] - u)), d[m] +
            u >
            s[g] &&
            (e.offsets.popper[m] += d[m] + u - s[g]), (e.offsets.popper = c(
            e.offsets.popper
          ));
          var b = d[m] + d[l] / 2 - u / 2,
          ...
          return (v = J(
            _(s[l] - u, v),
            0
          )), (e.arrowElement = n), (e.offsets.arrow = (
            (i = {}),
            pe(i, m, Math.round(v)),
            pe(i, h, ""),
            i
      ...
      inner: {
        ...
        fn: function(e) {
          ...
          return (n[p ? "left" : "top"] =
            r[o] - (s ? n[p ? "width" : "height"] : 0)), (e.placement = x(
            t
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          return (e.attributes = se({}, E, e.attributes)), (e.styles = se(
            {},
            m,
            e.styles
          )), (e.arrowStyles = se({}, e.offsets.arrow, e.arrowStyles)), e;
        },
        gpuAcceleration: !0,
        x: "bottom",
        y: "right",
      ...
      applyStyle: {
        ...
        enabled: !0,
        fn: function(e) {
          return Y(e.instance.popper, e.styles), j(
            e.instance.popper,
            e.attributes
          ), e.arrowElement &&
            Object.keys(e.arrowStyles).length &&
            Y(e.arrowElement, e.arrowStyles), e;
        },
